                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-4'>
                            ...
                            <div className='relative'>
                                ...
                                <select
                                    ...
                                    className='w-full pl-10 pr-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#14A800] appearance-none bg-white cursor-pointer'
                                >
