          ...
          <div className="container mx-auto px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <motion.div
                ...
                className="inline-flex items-center gap-2 bg-[#14A800]/10 text-[#14A800] px-5 py-2.5 rounded-full mb-8 border border-[#14A800]/20"
              >
                <Sparkles className="w-5 h-5" />
                <span className="font-semibold text-sm lg:text-base">Welcome to the Future of Freelancing</span>
              </motion.div>

              <h1 className="hero-title text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 bg-linear-to-r from-[#14A800] via-[#0f8000] to-[#14A800] bg-clip-text text-transparent font-display leading-tight">
                Find Your Next Great <br />Opportunity
              </h1>

              <p className="hero-subtitle text-base lg:text-xl text-base-content/70 mb-8 lg:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
